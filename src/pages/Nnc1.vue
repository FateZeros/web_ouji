<template>
    <el-row>
      <el-steps :active="active" finish-status="success">
        ...
        <el-step title="首任董事" :status="forthStatus"></el-step>
      </el-steps>
      ...
      <el-form v-show="active == 1" class="ncc1-page" ref="formPage1" :model="form" :rules="rules" label-width="150px">
        ...
        <el-row class="form-item-container">
            <el-row>
              <el-col :span="12">
                <el-form-item label="中文姓名:" prop="fNameCn">
                    <el-input v-model="form.fNameCn" placeholder="必须为中文"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="英文姓名:" prop="fNameEn">
                    <el-input v-model="form.fNameEn" placeholder="姓和名必须以'-'分割，如WU-JIANMIN"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item label="地址:" prop="fAddr">
              <el-input v-model="form.fAddr" placeholder="联络地址或证件地址"></el-input>
            </el-form-item>
            <el-row>
              <el-col :span="12">
                <el-form-item label="國家／地區:" prop="fCountry">
                    <el-input v-model="form.fCountry" placeholder="國家／地區"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="占股份的数目:" prop="fStockNum">
                    <el-input v-model="form.fStockNum" placeholder="小于等于發行股份總數"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item>
            ...
            <el-row v-show="form.isOtherChairman">
              <el-row>
                <el-col :span="12">
                  <el-form-item label="中文姓名:" prop="fNameCn1">
                      <el-input v-model="form.fNameCn1" placeholder="必须为中文"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="英文姓名:" prop="fNameEn1">
                      <el-input v-model="form.fNameEn1" placeholder="如WU JIANMIN"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-form-item label="地址:" prop="fAddr1">
                <el-input v-model="form.fAddr1" placeholder="联络地址或证件地址"></el-input>
              </el-form-item>
              <el-row>
                <el-col :span="12">
                  <el-form-item label="國家／地區:" prop="fCountry1">
                      <el-input v-model="form.fCountry1" placeholder="國家／地區"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="占股份的数目:" prop="fStockNum1">
                      <el-input v-model="form.fStockNum1" placeholder="小于等于發行股份總數"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-row>
            <el-form-item>
              <el-checkbox-group v-model="form.isOtherChairman" @change="changeOtherMem">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="公司編號:" prop="cNumber">
                    <el-input v-model="form.cNumber" placeholder="公司編號"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="公司邮件:" prop="cEmail">
                    <el-input v-model="form.cEmail" placeholder="公司邮件(NIL)"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item label="公司中文名稱:" prop="sNameCn">
                <el-input v-model="form.sNameCn" placeholder="公司中文名稱"></el-input>
            </el-form-item>
            <el-form-item label="公司英文名稱:" prop="sNameEn">
                <el-input v-model="form.sNameEn" placeholder="公司英文名稱"></el-input>
            </el-form-item>
            <el-form-item label="香港地址:" prop="sHKAddr">
                <el-input v-model="form.sHKAddr" placeholder="香港地址"></el-input>
            </el-form-item>
        </el-row>
      </el-form>

      <!-- page4 -->
      <el-form v-show="active == 3" class="ncc1-page" ref="formPage3" :model="form" :rules="rules" label-width="150px">
        <el-row class="nnc1-module-title">首任董事　First Directors</el-row>
        <el-row class="form-item-container">
          <el-row>
            <el-col :span="8">
              <el-form-item label="董事姓名:" prop="chNameCn">
          ...
          <el-form-item label="國家／地區:" prop="chCountry">
              <el-input v-model="form.chCountry" placeholder="國家／地區"></el-input>
          </el-form-item>
          <el-form-item label="住址:" prop="chAddr">
              <el-input v-model="form.chAddr" placeholder="联络地址或证件地址"></el-input>
          </el-form-item>
          ...
          <el-form-item v-show="form.certificateType == 'chinaId'" prop="chChinaId">
              <el-input v-model="form.chChinaId" placeholder="个人董事在中国大陆的身份证号码"></el-input>
          </el-form-item>
      ...
      <el-row class="btn-row">
        ...
        <el-button @click="nextPage" v-show="active !== 3">下一步</el-button>
        <el-button @click="nextPage" v-show="active == 3">提交</el-button>
      </el-row>
    </el-row>
</template>
